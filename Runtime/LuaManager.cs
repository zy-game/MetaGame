...
namespace GameFramework.Runtime
{
    public class LuaManager : Singleton<LuaManager>, IDisposable
    {
        ...
        private bool isLoadLocal;//是否加载本地代码
        ...
        public async void Init(Action callback = null)
        {
            ...
            isLoadLocal = (AppConst.config == null) || (Application.isEditor && !AppConst.config.editorUseLuaBytes);
            if (isLoadLocal)
            {
                load = LoadLuaFile;
        ...
        private void InitBuildLuaBytes()
        {
            ...
            //获取本地所有的代码文件路径
            LoadDirectoryLuaBytesName(AppConst.DataPath + AppConst.config.codeModuleName + "/", false);
        }
