...
{
    public class PageEditorAsset_old : BuildAssetPage
    {
        private class Item
        {
            public int index;
        ...
        public PageEditorAsset_old(AssetBundleBuildSetting buildSetting, AssetBundleBuildSetting.Page page) : base(buildSetting, page)
        {
            items = new List<Item>();
        ...
        private void DrawAssetItems()
        {
            ...
            selectCodeMask = EditorGUILayout.MaskField("选择代码包", selectCodeMask, codesPackage);
            GUILayout.Space(5);
            GUILayout.Box("", selfGUIStyle.line, GUILayout.Width(buildSetting.position.width), GUILayout.Height(3));
            GUILayout.Space(5);
